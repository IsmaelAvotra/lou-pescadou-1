...
function categories() {
  return (
    <div className="w-5/6 flex flex-row flex-wrap lg:flex-nowrap md:flex-row gap-x-5 lg:gap-x-20 text-sm md:text-xl justify-center items-center gap-y-10 text-white mb-5">
