  ...
  return (
    <div className="h-30 z-50 fixed backdrop-blur-3xl top-0 w-full">
      ...
      <div className="relative h-20 z-50 flex text-white justify-evenly bg-[#fff] items-center w-full custom-header">
        ...
        <Link href="/Login" className="drop-shadow-2xl text-2xl font-semibold text-[#79c8f5]">
          Connexion
        </Link>
        <Link href="/Signup" className="drop-shadow-2xl text-2xl font-semibold text-[#79c8f5] font-bold">
          S'inscrire
        </Link>
